...
function computeSum(){
  ...
  var input = document.getElementById("userStringNums").value
  var sum =0
...
function getName(){
 ...
 document.getElementById("userName").value = title.options[title.selectedIndex].text + " " + 
   first.value + " " +middle.value + " " + last.value + " "
  +
  suffix.options[suffix.selectedIndex].text
}

//Rest is all for the tic tac toe game, 
